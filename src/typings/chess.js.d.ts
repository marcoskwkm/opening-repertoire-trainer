// A patched version of the chess.js typings declaration that fixes the issue
// with the Chess export being converted into a default export by Webpack
...
declare module 'chess.js' {
   ...
   */
  export default (fen?: string) => ChessInstance
}
